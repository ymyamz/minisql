 ...
 */
  void Init(IndexMetadata *meta_data, TableInfo *table_info, BufferPoolManager *buffer_pool_manager) {
    ...
    Schema* s = table_info->GetSchema();
    key_schema_ = Schema::ShallowCopySchema(s, meta_data_->key_map_);
 ...
 private:
  ...
  Index *index_;
  TableInfo *table_info_;//add table_info
  IndexSchema *key_schema_;//index的关键词在table_schema中对应位置map
};
